...
@Component
public class MelhoresTarifasAereasClient {
    private static final String ENDPOINT = "CacheAereo/aereo/melhores-datas";
    private static final String MENSAGEM_CRITERIOS_INVALIDOS =
            "Os criterios da consulta de tarifas aereas sao invalidos.";
    ...
    public MelhoresTarifasAereasClient(
    ...
    public MelhoresTarifasAereasResponse consultar(MelhoresTarifasAereasRequest request) {
    ...
    private RuntimeException mapStatus(HttpStatusCodeException ex) {
        if (ex.getStatusCode().is4xxClientError()) {
            return new RegraDeNegocioException(
                    ex.getRawStatusCode(), mensagemSegura(ex));
        }
    ...
    private ResponseEntity<MelhoresTarifasAereasResponse> exchange(
        ...
        return restTemplate.exchange(
                ...
                MelhoresTarifasAereasResponse.class);
    }
