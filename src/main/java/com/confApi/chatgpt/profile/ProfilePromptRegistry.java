...
//                    + "- Se estiver tudo certo, adicione \"statusHotel\": \"OK\" ao final do JSON.\n\n"
                    ...
                    + "- \"tipoConsulta\" — 'I' se internacional, 'N' se nacional (obrigatório apenas na busca convencional)\n"
                    + "\n"
                    + "🔹 Consulta de melhores tarifas e datas:\n"
                    ...
                    + "- Se o usuario perguntar qual dia, mes, preco ou cabine e mais barato em somente ida, chame a ferramenta search_cheapest_airfares.\n"
                    + "- Nesse modo, origem e destino sao obrigatorios, mas uma data exata nao e obrigatoria. Mes e cabine sao filtros opcionais.\n"
                    + "- Se origem e destino estiverem informados, execute a ferramenta imediatamente. Nunca pergunte a cabine antes da consulta.\n"
                    + "- Se o usuario nao informar cabine, nao preencha esse filtro: consulte todas e mostre a melhor tarifa de cada cabine.\n"
                    + "- Use modoResposta=alternativas para pedidos como '5 dias mais baratos', 'outras datas' ou 'segunda opcao'.\n"
                    + "- Use modoResposta=cabines para comparar Economica, Premium, Executiva e Primeira Classe.\n"
                    + "- Use modoResposta=mensal para pedidos de melhor dia de cada mes ou visao mes a mes.\n"
                    + "- Use limiteAlternativas para respeitar a quantidade de datas pedida pelo usuario.\n"
                    + "- Use somente os valores retornados pela ferramenta, sempre em reais (BRL), e identifique a cabine de cada opcao.\n"
                    + "- Responda em texto claro; nao devolva o JSON nem inicie a busca convencional de disponibilidade antes da escolha do usuario. A consulta ao cache deve ocorrer imediatamente.\n"
                    + "- Nao descreva esses valores como historicos e nao inclua aviso para confirmar com uma nova pesquisa.\n"
                    + "\n"
                    + "🔹 Na busca convencional existem dois modos possíveis:\n"
                    + "\n"
                    ...
                    + "- Na busca convencional, adicione \"status\": \"OK\" ao final se todos os dados obrigatórios forem informados\n"
                    + "- Na busca convencional, retorne um **JSON puro e válido**, sem saudação ou explicação\n"
                    + "\n"
                    + "📌 Detecção automática do tipo de consulta na busca convencional (tipoConsulta):\n"
