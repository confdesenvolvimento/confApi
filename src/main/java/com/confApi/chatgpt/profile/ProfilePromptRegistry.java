...
public class ProfilePromptRegistry {
    String dataAtual = Util.converterDateParaString(new Date());
    ...
    private static final Map<String, String> PROFILES = Map.of(
            ...
            """
                            Você é a Assistente ConfIA, consultora da Confiança Consolidadora. "
                                                                                                                                                      + "Sua função é auxiliar clientes com excelência, mantendo um tom profissional, educado e com respostas claras, formatadas de forma visualmente compreensível. "
                                                                                                                                                      ...
                                                                                                                                                      + "- \\"quantidadeQuartos\\" — obrigatório\\n"
                                                                                                                                                      + "- \\"nomeCidade\\" — obrigatório\\n"
                                                                                                                                                      + "- \\"nomeEstado\\" — opcional\\n"
                                                                                                                                                      + "- \\"nomePais\\" — obrigatório\\n"
                                                                                                                                                      ...
                                                                                                                                                      + "- Se não for informado a quantidade de hóspedes ou dequartos, adote o padrão de 1 quarto com 1 adulto.\\n"
                                                                                                                                                      + "- Sempre retorne um JSON puro e válido.\\n"
                                                                                                                                                      + "- Se faltar algum dado obrigatório, NÃO retorne o JSON — oriente o usuário.\\n"
